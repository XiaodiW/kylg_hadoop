...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-Os -fomit-frame-pointer -g -Os -fomit-frame-pointer -g -Os '
           '-fomit-frame-pointer -g -DTHREAD_STACK_SIZE=0x100000',
 'CFLAGSFORSHARED': '-fPIC',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-Os -fomit-frame-pointer -g',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--disable-rpath' '--enable-ipv6' "
                ...
                "'--with-system-ffi' '--with-threads' 'CC=gcc' 'CFLAGS=-Os "
                "-fomit-frame-pointer -g' 'LDFLAGS=-Wl,--as-needed' "
                "'CPPFLAGS=-Os -fomit-frame-pointer'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.6m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/home/buildozer/aports/main/python3/src/Python-3.6.6/coverage.info',
 'COVERAGE_REPORT': '/home/buildozer/aports/main/python3/src/Python-3.6.6/lcov-report',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -Os -fomit-frame-pointer -g -Os -fomit-frame-pointer '
                   '-g -Os -fomit-frame-pointer -g '
                   '-DTHREAD_STACK_SIZE=0x100000 -std=c99 -Wextra '
                   '-Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -I. -I./Include -Os '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.6.6',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.6.6 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.6.6 '
 ...
 'abs_builddir': '/home/buildozer/aports/main/python3/src/Python-3.6.6',
 'abs_srcdir': '/home/buildozer/aports/main/python3/src/Python-3.6.6',
